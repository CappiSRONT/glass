...
HERE = os.path.dirname(os.path.abspath(__file__))   # .../Glass (repo root - this
ROOT = HERE                                            # file lives next to run.bat/VERSION)
VERSION_PATH = os.path.join(ROOT, "VERSION")
SKIP_MARKER = os.path.join(ROOT, ".glass_update_skip")   # remembers "user said no to THIS tag"
